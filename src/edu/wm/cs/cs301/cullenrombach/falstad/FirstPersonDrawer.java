...
public class FirstPersonDrawer extends DefaultViewer {
	...
	GraphicsWrapper gw ; // the graphics object for the buffer image this class draws on
	// note: updating the panel that is on screen with the buffer image is the responsibility of the maze class
	 ...
	 * @param mazew TODO
	 * @param mazeh TODO
	 * @param gw TODO   MEMO: unlikely to be known when constructor is called, likely to by null
	 */
	 ...
	 * @param gw graphics handler for the buffer image that this class draws on
	 ...
	 */
	@Override
	public void redraw(GraphicsWrapper gw, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {
