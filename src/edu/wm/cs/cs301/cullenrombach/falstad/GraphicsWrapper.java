...
import edu.wm.cs.cs301.cullenrombach.ui.GraphicsThread;
 ...
 * 
 * Aspects involving the SurfaceView are adapted from a tutorial at:
 * http://www.edu4java.com/en/androidgame/androidgame3.html
 * 
 * @author Cullen Rombach (cmromb)
 */

public class GraphicsWrapper extends SurfaceView {
	...
	private SurfaceHolder holder; // Holder for the SurfaceView.
	private GraphicsThread graphicsThread; // The thread that manages this GraphicsWrapper.
	...
	public GraphicsWrapper(Context context, AttributeSet attrs) {
		...
		// Set up the graphics thread.
		graphicsThread = new GraphicsThread(this);
		
		// Set up the Holder for the SurfaceView to work.
		holder = getHolder();
		holder.addCallback(new SurfaceHolder.Callback() {
			// What to do when the surface is destroyed.
			@Override
			...
			// Irrelevant to this particular project.
			@Override
