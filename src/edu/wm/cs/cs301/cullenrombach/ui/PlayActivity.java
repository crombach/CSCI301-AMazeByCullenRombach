...
public class PlayActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Get the energy bar and store it.
		...
		if(driverType.equals("Manual") == false) {
			runRobotDriver();
		}
	}
	...
	public void moveToFinish(View view) {
		// Log what we're doing.
		Log.v(TAG, "Moving to FinishActivity");
	...
	public void moveForward(View view) {
		...
		driverThread = new Thread(new Runnable() {
			public void run() {
				// Log what we're doing.
				Log.v(TAG, "Robot told to move forward");
	...
	public void moveBackward(View view) {
		...
		driverThread = new Thread(new Runnable() {
			public void run() {
				// Log what we're doing.
				Log.v(TAG, "Robot told to move backward");
	...
	public void moveLeft(View view) {
		...
		driverThread = new Thread(new Runnable() {
			public void run() {
				// Log what we're doing.
				Log.v(TAG, "Robot told to turn left");
	...
	public void moveRight(View view) {
		...
		driverThread = new Thread(new Runnable() {
			public void run() {
				// Log what we're doing.
				Log.v(TAG, "Robot told to turn right");
	...
	private void runRobotDriver() {
		...
		driverThread = new Thread(new Runnable() {
			public void run() {
				...
				Log.v(TAG, "RobotDriver started");
				
				maze.runRobotDriver();
				
				// Log that the driver is done.
				Log.v(TAG, "RobotDriver finished");
